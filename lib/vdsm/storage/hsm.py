...
class HSM(object):
    ...
    def measure(self, sdUUID, imgUUID, volUUID, dest_format, backing=True):
        ...
        Arguments:
            sdUUID(UUID): The UUID of the storage domain that owns the volume.
            imgUUID(UUID): The UUID of the image contained on the volume.
            volUUID(UUID): The UUID of the volume you want to get the info on.
        ...
        Returns:
            dict containing measure result (required and fully-allocated size)
        """
